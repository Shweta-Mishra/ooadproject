						...
						<div class="unitExt mainUnit">
							<div class="header-links unitExt">
								<ul class="link-list fk-font-12 fk-text-center required-tracking"
									...
									<li><a href="getOrderID" id="notifications-link"
									...
									<li><a class="signup-link" href="Logout">Logout</a>
									</li>
									</ul>
							</div>
							<!-- search engine -->
					...
					<div class="menubar newMenu slowMenu">
						<div class="top-menu unit">
							<ul class="menu-links required-tracking" data-tracking-id="nmenu">
								...
								<li class="menu-l0 " id="Electronics"><a href="getSellerInfo"class="menu-text fk-inline-block"> <span>View Seller Profile</span>
								</a> 
									</li>
								<li class="menu-l0 " id="Electronics"><a href="InsertBySeller"class="menu-text fk-inline-block"> <span>Add Product detail</span>
								</a> 
									</li>			
								<li class="menu-l0 " id="Electronics"><a href="sellerBalance"class="menu-text fk-inline-block"> <span>Account Detail</span>
								</a> 
									</li>						
							</ul>
					</div>
