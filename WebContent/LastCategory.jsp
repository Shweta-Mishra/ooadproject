			...
			<div class="fk-content fksk-content enable-compare">
				...
				<div class="gd-row">
					<div class="gd-col gu16 top-section">
						<form class="form-horizontal" method="post" action="insertLastCategory" enctype="multipart/form-data">
								<div class="form-group">
								<label  class="col-sm-2 control-label"> Recent Last category
									ID:</label>
								<label  class="col-sm-2"><s:property value="LC_ID"  /></label>	
							</div>
							<div class="form-group">
							
								<label for="LC_ID" class="col-sm-2 control-label"> Last category
									ID:</label>
								<div class="col-sm-5 ">
									<input type="text" class="form-control" name="LC_ID"
										placeholder="Enter Last category id" id="LC_ID" />
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label"> Last category name:</label>
								<div class="col-sm-5 ">
									<input type="text" class="form-control" name="LC_NAME"
										placeholder="ENTER LC name" id="LC_NAME" />
								</div>
							</div>
															<div class="form-group">
