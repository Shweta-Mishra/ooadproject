...
<div id="fk-mainbody-id" class="fk-mainbody fksk-mainbody   ">
	...
	<div class="col-md-10" style="background-color: #FFFFFF">
			...
			<ul style="list-style-type: none">
				...
				<li class="padding2"><a class="padding3">Deactivate Account</li>
				</a>
				<li class="padding2" style="padding: 4px 0 4px 6px"><s:url
			...
			<form action="DeactivateAccountFromDB">
			<div class="form-group">
					<div class="row">
  						<div class="col-md-2"> <label for="Name" >EmailID</label>
 						 </div>
...
String s= (String)session.getAttribute("email");
					out.print(s);%>
 						 ...
 						 <div class="form-group">
					<div class="row">
  						<div class="col-md-2"> <label for="Name" >Password</label>
 						 </div>
