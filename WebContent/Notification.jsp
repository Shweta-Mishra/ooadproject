...
<div id="fk-mainbody-id" class="fk-mainbody fksk-mainbody   ">
	...
	<div class="col-md-10" style="background-color: #FFFFFF">
			...
			<s:iterator value="Orders">
				<div
					class="line tpadding10 bpadding10 lpadding15 rpadding10 notification-content notification-read ">
					<div class="lastUnit">
						<span class="notification-text">Your Flipkart order# <strong><s:property
									value="getOrderid()" /> </strong> has been <strong> <s:property
									value="getStatus()" />
						</strong>.
						</span>
					</div>
					<div class="line tpadding5">
						<div class="notification-timestamp lastUnit">
							<s:property value="getDays_ago()" />
							days ago
						</div>
					</div>
				</div>
