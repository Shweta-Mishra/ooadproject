...
<div id="fk-mainbody-id" class="fk-mainbody fksk-mainbody   ">
	...
	<div class="col-md-10" style="background-color: #FFFFFF">
			...
			<ul style="list-style-type: none">
				...
				<li class="padding2"><a class="padding3">Update Email</a></li>
				<li class="padding2"><a class="padding3"
		 ...
		 <strong>Enter the new Email ID that you wish to
				associate with your Flipkart account.</strong>
			<form action="updatemail">
			
			<div class="form-group">
					<div class="row">
  						<div class="col-md-4"> <label for="Name" >Email Address</label>
 						 </div>
 						 <div class="col-md-2"> <label id="id">
								<% 
String s= (String)session.getAttribute("email");
					out.print(s);%>
 						 ...
 						 <div class="form-group">
					<div class="row">
  						<div class="col-md-4"> <label for="Name" >New Email ID</label>
 						 </div>
 						 <div class="col-md-2"> <input type="text"
							id="userEmail" name="newemail" class="textbox" required="true"
 					 ...
 					 <div class="form-group">
					<div class="row">
  						<div class="col-md-2"> <label for="Name"></label>
 						 </div>
 						 <div class="col-md-4"> <p id="checking">Check for
								availability</p>
					...
					<div class="row">
  						<div class="col-md-2"> 
 						 <s:submit value="SAVE CHANGES" class="btn btn-primary"/></div></div></div>
