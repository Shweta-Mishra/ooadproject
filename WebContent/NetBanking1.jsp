		...
		<table cellspacing="20">
			<tr>
				...
				<td><button id="Bank_Pay2" type="button">
						<img src="images/icici.jpeg" name="icici" height="50px"
							width="200px">
					</button></td>
			</tr>
			<tr>
				...
				<td><button id="Bank_Pay4" type="button">
						<img src="images/sbi.png" name="sbi" height="50px" width="200px">
					</button></td>
				<td><button id="Bank_Pay5" type="button">
						<img src="images/kotek.jpeg" name="kotek" height="50px"
							width="200px">
					</button></td>
			</tr>
		</table>
